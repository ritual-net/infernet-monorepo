...
Retrieve information about the node. See [NodeInfo](https://docs.ritual.net/infernet/node/api#nodeinfo).
...
Create a new direct compute request. See [JobRequest](https://docs.ritual.net/infernet/node/api#jobrequest)
...
See [JobRequest](https://docs.ritual.net/infernet/node/api#jobrequest), [JobResponse](https://docs.ritual.net/infernet/node/api#jobresponse),
and [ErrorResponse](https://docs.ritual.net/infernet/node/api#errorresponse).
...
Fetch direct compute results. See [JobResult](https://docs.ritual.net/infernet/node/api#jobresult).
...
See [JobRequest](https://docs.ritual.net/infernet/node/api#jobrequest) and [JobResult](https://docs.ritual.net/infernet/node/api#jobresult).
...
See [/api/jobs/stream](https://docs.ritual.net/infernet/node/api#post-apijobsstream).
...
and [DelegatedSubscriptionRequest](https://docs.ritual.net/infernet/node/api#delegatedsubscriptionrequest).
...
See [/api/status](https://docs.ritual.net/infernet/node/api#put-apistatus).
